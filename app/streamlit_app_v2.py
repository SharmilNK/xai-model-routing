...
def plot_shap_waterfall(features, predictor, predicted_tier):
    ...
    ax.set_title('Feature Contributions (SHAP-style) | Red→Complex | Blue→Simple', 
...
def main():
    ...
    # ========================================================================
    st.markdown("---")
    st.subheader("🧪 Why This Decision? (SHAP-style Analysis)")
    ...
    # ========================================================================
    st.markdown("---")
    st.subheader("⚖️ Model Tier Comparison")
